...
class TestRemoteCloudRecording:
    ...
    def test_remote_cloud_record_main_page_text(self, device_config):
        ...
        BasePage().check_key_in_yaml(remote_items, 'cloud_recording')
        ...
        # 验证云录像主页文案
        main_text_res, illegal_funcs_res = RemoteCloudRecord().check_cloud_recording_main_text(main_text=remote_items['cloud_recording']['text'])
